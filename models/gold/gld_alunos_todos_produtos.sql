...
WHERE
    ...
    OR 
        ...
        AND VOLUME IN ('1', 'Único', 'U'))
GROUP BY [CÓDIGO DO CLIENTE],[NOME DO CLIENTE], [REDE DE ENSINO], [CIDADE], [UF], [ANO DE UTILIZAÇÃO],SEGMENTO, [SÉRIE],[DESCRIÇÃO],[COLEÇÃO], [GRUPO COLEÇÃO], [CATEGORIA PADRONIZADA]